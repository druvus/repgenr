...
| `--drop-selection` |  | ReadsParams.drop_selection | none | params.reads_args | n/a: network stage; covered offline on frozen ENA fixtures in tests/unit/test_reads_stage.py | docs/usage.md, docs/cli-reference.md, docs/audit/cli-matrix.md |
